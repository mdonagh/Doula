class AffiliateSignupsController < ApplicationController
    ...
    def show 
        ...
        @terms_and_conditions = "1. ACKNOWLEDGMENT AND ACCEPTANCE OF TERMS OF SERVICE
    ...
    def contact_params
        params.require(:affiliate).permit(:business_name, :website, :phone, contact_name: [:first_name, :last_name], address: [:street_address, :address_line2, :city, :state, :zip_code])
    end
